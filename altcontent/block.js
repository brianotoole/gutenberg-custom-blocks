...
(function() {
	...
	var Editable = wp.editor.RichText; // Editable component of React.
	//var children = wp.blocks.source.children; // The childern() function to extract child nodes from a paragraph of rich text.
	 ...
	 */
	registerBlockType( 'bzo/altcontent-block', { // Block namespace. Example: plugin/block-name.
		title: 'Alternating Content Block', // Block title.
